...
namespace VRTK
{
    ...
    public class VRTK_ObjectTooltip : MonoBehaviour
    {
        ...
        {
            //ToolTip._instance.AttemptAddBehaviourToToggleOnLoadedSetupChange(this);
        ...
        {
            //ToolTip._instance.AttemptRemoveBehaviourToToggleOnLoadedSetupChange(this);
        }
        ...
        protected virtual void Update()
        {
            ...
            {
                ToolTip.transform.LookAt(headset);
        ...
        {
            line = transform.Find("Line1").GetComponent<LineRenderer>();
            line.material = Resources.Load("Blue") as Material;
